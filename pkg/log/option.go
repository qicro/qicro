...
type Options struct {
	...
	Level             string   `json:"level"              mapstructure:"level"`              // Level 运行log的最低等级
	Format            string   `json:"format"             mapstructure:"format"`             // Format 目前只有两种选择 console json
	DisableCaller     bool     `json:"disable-caller"     mapstructure:"disable-caller"`
	DisableStacktrace bool     `json:"disable-stacktrace" mapstructure:"disable-stacktrace"`
	EnableColor       bool     `json:"enable-color"       mapstructure:"enable-color"`
	Development       bool     `json:"development"        mapstructure:"development"` // development mode
